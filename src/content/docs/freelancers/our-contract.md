...
Bevor wir dich bei einem Kunden für einen [Direktjob](direct-jobs/) vorstellen können, bitten wir dich, unseren Vertrag zu unterschreiben. Dieser beinhaltet folgende Punkte:

1. Wenn es mit dem Kunden, mit dem du über Uplink in Kontakt gekommen ist, zu einer Zusammenarbeit kommt, berechnen wir dir für die ersten 12 Monate dieser Zusammenarbeit [eine Gebühr von 10% deines Honorars](our-fee/). Diese Gebühr fällt nur an, wenn die Zusammenarbeit innerhalb von 12 Monaten nach unserer Vorstellung startet.
...
Da bei [Recruiter-Jobs](recruiter-jobs/) keine Gebühr anfällt, kannst du dich für diese bewerben, ohne den Vertrag unterschreiben zu müssen.
